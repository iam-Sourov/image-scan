    ...
    <div className="w-full max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 space-y-6">
          <Card className="overflow-hidden border-0 shadow-xl bg-white/50 dark:bg-black/30 backdrop-blur-md">
            ...
            <CardHeader className="text-center">
              <CardTitle className="text-2xl font-bold tracking-tight">Authenticity Report</CardTitle>
              <CardDescription>Advanced forensics scan complete.</CardDescription>
            </CardHeader>
          </Card>
        </div>
        ...
        <div className="flex-1 space-y-6">
          <Card className="border-slate-200 dark:border-slate-800 shadow-xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-md">
            <CardHeader className="pb-2">
              <CardTitle className="text-lg">Human-Made Probability</CardTitle>
            </CardHeader>
          ...
          <Card className="border-slate-200 dark:border-slate-800 shadow-xl bg-white/60 dark:bg-slate-900/60 backdrop-blur-md">
            <CardHeader className="pb-2">
              <CardTitle className="text-lg">Artifact Detection</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="pt-4 mt-4 border-t border-slate-200 dark:border-slate-700 grid grid-cols-3 gap-2 text-center">
